...
public class HomeLayout extends BaseLayout {
    ...
    protected void initBaseLayouts() {
        ...
        //list and map
        homeListMapLayout = new DscHomeListMapLayout(getBaseLayoutActivity(),_categories);
        loadLayout(R.id.fragLayout, homeListMapLayout, true);

        // Menus
        menuLeftLayout = new MenuLeftLayout(getBaseLayoutActivity(), _cities, _privateToken, _document, _amountSaved);
    ...
    protected void initValues() {
        tvLeftTitle.setText("BIENVENIDO " + _privateToken.FullName);
        //references to baselayouts
        ...
        if (categorySelected == null) {
            ...
            if (homeListMapLayout != null) {
                ...
                menuLeftLayout.loadCities(_cities);
            ...
            if (service.equals(ServiceLauncher.UserPromotions)) {
                ...
                if (responseCategories.State) {
                    ...
                    if (responseCategories.Data.size() > 0) {
                        homeListMapLayout.reloadCategories(_categories);
